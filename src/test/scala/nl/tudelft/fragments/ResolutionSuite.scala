...
class ResolutionSuite extends FunSuite {
  ...
  implicit val language: Language = new Language(Nil, null, new Specification(resolutionParams, null, Nil), null, Nil, null)
  ...
  test("single declaration when multiple max labels") {
    ...
    val language = new Language(Nil, null, new Specification(resolutionParams, null, Nil), null, Nil, null)
