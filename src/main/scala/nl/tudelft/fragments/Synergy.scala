...
object Synergy {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val states = (0 to 20000).toList.flatMap(i => {
      ...
      //val start = Rule("Init", SortVar("y"), Some(Var("x613")), List(TermAppl("s349")), State(TermAppl("Mod", List(TermAppl("Let", List(TermAppl("Cons", List(TermAppl("TypeDecs", List(TermAppl("Conss", List(Var("x386"), Var("x387"))))), TermAppl("Nil", List()))), TermAppl("Cons", List(TermAppl("Record", List(Var("x610"), TermAppl("Cons", List(Var("x770"), Var("x771"))))), TermAppl("Nil", List()))))))),List(CDistinct(Declarations(TermAppl("s769"), "All")), CGenRecurse("Map", Var("x387"), List(TermAppl("s769")), None, SortAppl("List", List(SortAppl("TypeDec", List())))), CGenRecurse("Default", Var("x386"), List(TermAppl("s769")), None, SortAppl("TypeDec", List())), CGenRecurse("Default", Var("x610"), List(TermAppl("s769")), Some(TermAppl("RECORD", List(Var("x614")))), SortAppl("TypeId", List())), CGenRecurse("Map2", Var("x771"), List(TermAppl("s768"), TermAppl("s769")), None, SortAppl("List", List(SortAppl("InitField", List())))), CGenRecurse("Default", Var("x770"), List(TermAppl("s768"), TermAppl("s769")), None, SortAppl("InitField", List()))),List(CGDecl(TermAppl("s349"),ConcreteName("Type", "int", -1)), CGDecl(TermAppl("s349"),ConcreteName("Type", "string", -1)), CGDecl(TermAppl("s349"),ConcreteName("Var", "print", -1)), CGDecl(TermAppl("s349"),ConcreteName("Var", "flush", -1)), CGDecl(TermAppl("s349"),ConcreteName("Var", "getchar", -1)), CGDecl(TermAppl("s349"),ConcreteName("Var", "ord", -1)), CGDecl(TermAppl("s349"),ConcreteName("Var", "chr", -1)), CGDecl(TermAppl("s349"),ConcreteName("Var", "size", -1)), CGDecl(TermAppl("s349"),ConcreteName("Var", "substring", -1)), CGDecl(TermAppl("s349"),ConcreteName("Var", "concat", -1)), CGDecl(TermAppl("s349"),ConcreteName("Var", "not", -1)), CGDecl(TermAppl("s349"),ConcreteName("Var", "exit", -1)), CGDirectEdge(TermAppl("s769"),Label('P'),TermAppl("s349")), CGDirectEdge(TermAppl("s768"),Label('I'),Var("x614"))),TypeEnv(Map(Binding(ConcreteName("Var", "concat", -1), TermAppl("FUN", List(TermAppl("Cons", List(TermAppl("STRING", List()), TermAppl("Cons", List(TermAppl("STRING", List()), TermAppl("Nil", List()))))), TermAppl("STRING", List())))), Binding(ConcreteName("Var", "size", -1), TermAppl("FUN", List(TermAppl("Cons", List(TermAppl("STRING", List()), TermAppl("Nil", List()))), TermAppl("INT", List())))), Binding(ConcreteName("Var", "print", -1), TermAppl("FUN", List(TermAppl("Cons", List(TermAppl("STRING", List()), TermAppl("Nil", List()))), TermAppl("UNIT", List())))), Binding(ConcreteName("Var", "ord", -1), TermAppl("FUN", List(TermAppl("Cons", List(TermAppl("STRING", List()), TermAppl("Nil", List()))), TermAppl("INT", List())))), Binding(ConcreteName("Var", "chr", -1), TermAppl("FUN", List(TermAppl("Cons", List(TermAppl("INT", List()), TermAppl("Nil", List()))), TermAppl("STRING", List())))), Binding(ConcreteName("Type", "string", -1), TermAppl("STRING", List())), Binding(ConcreteName("Var", "substring", -1), TermAppl("FUN", List(TermAppl("Cons", List(TermAppl("INT", List()), TermAppl("Cons", List(TermAppl("INT", List()), TermAppl("Cons", List(TermAppl("STRING", List()), TermAppl("Nil", List()))))))), TermAppl("STRING", List())))), Binding(ConcreteName("Var", "not", -1), TermAppl("FUN", List(TermAppl("Cons", List(TermAppl("INT", List()), TermAppl("Nil", List()))), TermAppl("INT", List())))), Binding(ConcreteName("Var", "exit", -1), TermAppl("FUN", List(TermAppl("Cons", List(TermAppl("INT", List()), TermAppl("Nil", List()))), TermAppl("UNIT", List())))), Binding(ConcreteName("Var", "getchar", -1), TermAppl("FUN", List(TermAppl("Nil", List()), TermAppl("STRING", List())))), Binding(ConcreteName("Var", "flush", -1), TermAppl("FUN", List(TermAppl("Nil", List()), TermAppl("UNIT", List())))), Binding(ConcreteName("Type", "int", -1), TermAppl("INT", List())))),Resolution(Map()),SubtypeRelation(List()),List()))
      val start = Rule("Init", SortVar("y"), Some(Var("x613")), List(TermAppl("s349")), State(TermAppl("Mod", List(TermAppl("Let", List(TermAppl("Cons", List(TermAppl("TypeDecs", List(TermAppl("Conss", List(TermAppl("TypeDec", List(Var("x286"), Var("x287"))), TermAppl("Nil", List()))))), TermAppl("Nil", List()))), TermAppl("Cons", List(TermAppl("Record", List(TermAppl("Tid", List(Var("x484"))), TermAppl("Cons", List(Var("x770"), TermAppl("Nil", List()))))), TermAppl("Nil", List()))))))),List(CDistinct(Declarations(TermAppl("s101"), "All")), CGenRecurse("Default", Var("x770"), List(TermAppl("s101"), TermAppl("s101")), None, SortAppl("InitField", List())), CGenRecurse("Default", Var("x287"), List(TermAppl("s101")), Some(TermAppl("RECORD", List(Var("x614")))), SortAppl("Type", List()))),List(CGDecl(TermAppl("s349"),ConcreteName("Type", "int", -1)), CGDecl(TermAppl("s349"),ConcreteName("Type", "string", -1)), CGDecl(TermAppl("s349"),ConcreteName("Var", "print", -1)), CGDecl(TermAppl("s349"),ConcreteName("Var", "flush", -1)), CGDecl(TermAppl("s349"),ConcreteName("Var", "getchar", -1)), CGDecl(TermAppl("s349"),ConcreteName("Var", "ord", -1)), CGDecl(TermAppl("s349"),ConcreteName("Var", "chr", -1)), CGDecl(TermAppl("s349"),ConcreteName("Var", "size", -1)), CGDecl(TermAppl("s349"),ConcreteName("Var", "substring", -1)), CGDecl(TermAppl("s349"),ConcreteName("Var", "concat", -1)), CGDecl(TermAppl("s349"),ConcreteName("Var", "not", -1)), CGDecl(TermAppl("s349"),ConcreteName("Var", "exit", -1)), CGDirectEdge(TermAppl("s101"),Label('P'),TermAppl("s349")), CGDirectEdge(TermAppl("s101"),Label('I'),Var("x614")), CGDecl(TermAppl("s101"),SymbolicName("Type", "x286")), CGRef(SymbolicName("Type", "x484"),TermAppl("s101"))),TypeEnv(Map(Binding(ConcreteName("Var", "concat", -1), TermAppl("FUN", List(TermAppl("Cons", List(TermAppl("STRING", List()), TermAppl("Cons", List(TermAppl("STRING", List()), TermAppl("Nil", List()))))), TermAppl("STRING", List())))), Binding(ConcreteName("Var", "size", -1), TermAppl("FUN", List(TermAppl("Cons", List(TermAppl("STRING", List()), TermAppl("Nil", List()))), TermAppl("INT", List())))), Binding(ConcreteName("Var", "print", -1), TermAppl("FUN", List(TermAppl("Cons", List(TermAppl("STRING", List()), TermAppl("Nil", List()))), TermAppl("UNIT", List())))), Binding(SymbolicName("Type", "x286"), TermAppl("RECORD", List(Var("x614")))), Binding(ConcreteName("Var", "ord", -1), TermAppl("FUN", List(TermAppl("Cons", List(TermAppl("STRING", List()), TermAppl("Nil", List()))), TermAppl("INT", List())))), Binding(ConcreteName("Var", "chr", -1), TermAppl("FUN", List(TermAppl("Cons", List(TermAppl("INT", List()), TermAppl("Nil", List()))), TermAppl("STRING", List())))), Binding(ConcreteName("Type", "string", -1), TermAppl("STRING", List())), Binding(ConcreteName("Var", "substring", -1), TermAppl("FUN", List(TermAppl("Cons", List(TermAppl("INT", List()), TermAppl("Cons", List(TermAppl("INT", List()), TermAppl("Cons", List(TermAppl("STRING", List()), TermAppl("Nil", List()))))))), TermAppl("STRING", List())))), Binding(ConcreteName("Var", "not", -1), TermAppl("FUN", List(TermAppl("Cons", List(TermAppl("INT", List()), TermAppl("Nil", List()))), TermAppl("INT", List())))), Binding(ConcreteName("Var", "exit", -1), TermAppl("FUN", List(TermAppl("Cons", List(TermAppl("INT", List()), TermAppl("Nil", List()))), TermAppl("UNIT", List())))), Binding(ConcreteName("Var", "getchar", -1), TermAppl("FUN", List(TermAppl("Nil", List()), TermAppl("STRING", List())))), Binding(ConcreteName("Var", "flush", -1), TermAppl("FUN", List(TermAppl("Nil", List()), TermAppl("UNIT", List())))), Binding(ConcreteName("Type", "int", -1), TermAppl("INT", List())))),Resolution(Map(Tuple2(SymbolicName("Type", "x484"), SymbolicName("Type", "x286")))),SubtypeRelation(List()),List()))
